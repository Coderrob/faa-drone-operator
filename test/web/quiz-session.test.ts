...
import { correctAnswerCount, formatRemaining, isCompatibleSession, parseHistory, parseSession, scorePercent, toggleQuestionFlag } from "../../web/lib/quiz-session";
...
describe("quiz session utilities", () => {
  it("validates compatible sessions", () => {
  ...
  it("parses sessions defensively", () => {
