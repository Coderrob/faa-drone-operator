...
import { choiceButton, citationList, escapeHtml, feedbackView, historyCards, navigatorButton } from "../../web/lib/quiz-view";
...
describe("quiz view utilities", () => {
  it("escapes all significant HTML characters", () => {
    expect(escapeHtml(`<a href='x'>&"`)).toBe("&lt;a href=&#39;x&#39;&gt;&amp;&quot;");
  });

  it("renders safe citation markup", () => {
  ...
  it("renders each answer-choice state", () => {
...
describe("quiz history views", () => {
  it("renders feedback and navigator states", () => {
  ...
  it("renders only the five newest history entries newest first", () => {
    const entries = Array.from({ length: 6 }, (_, index) => ({ mode: index ? "study" : "exam", form: "A", completedAt: "2026-01-01T00:00:00Z", correct: index, total: 10, percent: index * 10 }));
  ...
  it("renders the exam form label", () => {
