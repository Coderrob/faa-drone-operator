...
describe("documents", () => {
  describe("getDocuments, getDocument, renderDocument, and rewriteLinks", () => {
    ...
    it("should preserve fragments and links outside the repository", () => {
      expect(rewriteLinks("[guide](01-certification-roadmap.md#apply)", "docs/index.md")).toContain("/learn/certification-roadmap/#apply");
      expect(rewriteLinks("[outside](../../outside.md)", "docs/index.md")).toBe("[outside](../../outside.md)");
    });
  });
});
