    ...
    sessions: [
      {
        ...
        completedAt,
        answers: [{ questionId: "Q", acsCode: "UA.I.A.K1", selectedIndex: 0, correct }],
      },
    ],
  };
}
...
describe("history", () => {
  ...
  describe("readHistory and appendSession", () => {
  ...
  describe("readHistory and remediationIds", () => {
