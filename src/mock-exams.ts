 ...
 */
export function selectMockForm(formId: string, questions: readonly Question[]): Question[] {
  const form = (formsJson as readonly MockForm[]).find(({ id }) => id.toUpperCase() === formId.toUpperCase());
